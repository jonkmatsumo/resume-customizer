...
CREATE TABLE artifacts (
    ...
    category TEXT,          -- 'ingestion', 'experience', 'research', 'rewriting', 'validation'
...
COMMENT ON COLUMN artifacts.category IS 'Phase: ingestion, experience, research, rewriting, validation';
